...
#add in the entry of text display
def button_click(char):
    global calc_operator
    calc_operator += str(char)
    text_input.set(calc_operator)

#clear the whole entry of text display
...
#trigonometric numbers of an angle
def trig_sin():
    global calc_operator
...
# cube root of a number
cube_root = Button(tk_calc, button_params, text='\u00B3\u221A',
                    command=cube_root).grid(row=4, column=1, sticky="nsew")
...
delete_one = Button(tk_calc, bd=5, fg='#000', font=('sans-serif', 20, 'bold'),
              text='DEL', command=button_delete, bg='#3db20f').grid(row=6, column=3, sticky="nsew")
delete_all = Button(tk_calc, bd=5, fg='#000', font=('sans-serif', 20, 'bold'),
              text='AC', command=button_clear_all, bg='#3db20f').grid(row=6, column=4, sticky="nsew")
